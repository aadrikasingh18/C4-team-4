const Checkbox = (props) => {
  ...
  return (
    <input
      ...
      justify-center rounded-md border border-darklow text-white/0 outline-none transition duration-[0.2s]
      checked:border-none checked:text-white hover:cursor-pointer dark:border-white/30 ${
        color === "red"
